...
class Product(models.Model):
    ...
    keywords = models.TextField(null=True, blank=True, help_text="Palavras-chave separadas por vírgulas para busca.")
    is_active_pdv = models.BooleanField(default=True, help_text="Produto ativo para exibição no PDV")
    is_active_site = models.BooleanField(default=True, help_text="Produto ativo para exibição no site")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
