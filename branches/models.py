...
class Branch(models.Model):
    ...
    tva = models.CharField(max_length=30, null=True, blank=True)
    unit_etablissement = models.CharField(max_length=50, null=True, blank=True)
    ...
    country = models.ForeignKey(Country, related_name='branches_country', on_delete=models.PROTECT, null=True, blank=True)
    image = models.ImageField(upload_to='branch/images/', blank=True, null=True)
    description = models.TextField(null=True, blank=True)
    is_active = models.BooleanField(default=True)
    close_date = models.DateTimeField(null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='branches_created_user', on_delete=models.PROTECT)
    updated_by = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='branches_updated_user', null=True, blank=True, on_delete=models.PROTECT)
    ...
    def save(self, *args, **kwargs):
        ...
        if self.pk:
            try:
                this = Branch.objects.get(pk=self.pk)
...
def delete_image_on_clear(sender, instance, **kwargs):
    if instance.pk:
        try:
            this = Branch.objects.get(pk=instance.pk)
